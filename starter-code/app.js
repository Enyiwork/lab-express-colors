...
app.get("/colors", (req, res, next) => {
  ...
  res.locals.colorListt = colors;
  res.render("colorList.ejs");

app.get("/green-color", (req, res, next) => {
  res.locals.allGreen = colors;
  res.render("green-color.ejs");
});

app.get("/purple-color", (req, res, next) => {
  res.locals.allPurple = colors;
  res.render("pouple-color.ejs");
});

app.get("/pink-color", (req, res, next) => {
  res.locals.allPink = colors;
  res.render("pink.ejs");
});
